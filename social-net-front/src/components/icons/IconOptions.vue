<template>
  <svg width="64px" height="64px" viewBox="0 0 32 32" enable-background="new 0 0 32 32" id="Stock_cut" version="1.1"
    xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="">
    <path
      ...
      fill="none" stroke="" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"></path>
    <circle cx="16" cy="16" fill="none" r="5" stroke="" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2">
    </circle>
  </svg>
</template>
